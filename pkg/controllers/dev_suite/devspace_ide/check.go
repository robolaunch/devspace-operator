...
func (r *DevSpaceIDEReconciler) reconcileCheckService(ctx context.Context, instance *devv1alpha1.DevSpaceIDE) error {
	...
	if err != nil {
		...
		if instance.Spec.Ingress {
			instance.Status.ServiceStatus.URL = devv1alpha1.GetDevSpaceServiceDNS(*devspace, "https://", "/ide/")
...
func (r *DevSpaceIDEReconciler) reconcileCheckPod(ctx context.Context, instance *devv1alpha1.DevSpaceIDE) error {
...
func (r *DevSpaceIDEReconciler) reconcileCheckIngress(ctx context.Context, instance *devv1alpha1.DevSpaceIDE) error {

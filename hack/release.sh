...
# make docker-build docker-push gh-extract IMG=robolaunchio/devspace-controller-manager:$1
make docker-buildx gh-extract IMG=robolaunchio/devspace-controller-manager:v$1
make gh-select-node LABEL_KEY="robolaunch.io/organization" LABEL_VAL="robolaunch"
make gh-select-node LABEL_KEY="robolaunch.io/team" LABEL_VAL="development"

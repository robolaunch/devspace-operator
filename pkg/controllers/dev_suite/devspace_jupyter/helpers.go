...
func (r *DevSpaceJupyterReconciler) reconcileGetTargetDevSpaceVDI(ctx context.Context, instance *devv1alpha1.DevSpaceJupyter) (*devv1alpha1.DevSpaceVDI, error) {
...
func (r *DevSpaceJupyterReconciler) reconcileCheckNode(ctx context.Context, instance *devv1alpha1.DevSpace) (*corev1.Node, error) {

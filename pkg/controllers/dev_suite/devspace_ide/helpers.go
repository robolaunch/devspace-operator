...
func (r *DevSpaceIDEReconciler) reconcileGetInstance(ctx context.Context, meta types.NamespacedName) (*devv1alpha1.DevSpaceIDE, error) {
	instance := &devv1alpha1.DevSpaceIDE{}
	err := r.Get(ctx, meta, instance)
	if err != nil {
		return &devv1alpha1.DevSpaceIDE{}, err
	}

	return instance, nil
}

func (r *DevSpaceIDEReconciler) reconcileUpdateInstanceStatus(ctx context.Context, instance *devv1alpha1.DevSpaceIDE) error {
	return retry.RetryOnConflict(retry.DefaultRetry, func() error {
		instanceLV := &devv1alpha1.DevSpaceIDE{}
